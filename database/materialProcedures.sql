...
CREATE PROCEDURE INSERTORDINATEUR(IN REF VARCHAR(47), IN SERIE 
...
CREATE PROCEDURE INSERTSWITCH(IN REF VARCHAR(47), IN MARQUE 
...
CREATE PROCEDURE INSERTIMPRIMANTE(IN REF VARCHAR(47), IN MARQUE 
...
CREATE PROCEDURE INSERTSERVEUR(IN REF VARCHAR(47), MARQUE VARCHAR
...
CREATE PROCEDURE INSERTABONNEMENT(IN REF VARCHAR(47), IN OPERATEUR 
...
CREATE PROCEDURE INSERTPOINTACCESINTERNET(IN REF VARCHAR(47)
...
CREATE PROCEDURE INSERTAUTRE(IN REF VARCHAR(47), IN MARQUE 
VARCHAR(50), IN MODELE VARCHAR(50), IN SERIE VARCHAR
...
CREATE PROCEDURE INSERTTELEPHONE(IN REF VARCHAR(47), IN MARQUE 
...
CREATE PROCEDURE INSERTRACCORDEMENT(IN REF VARCHAR(47), IN 
