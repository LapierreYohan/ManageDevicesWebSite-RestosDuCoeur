...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            <h1 class="mb-4">Liste des Types de Logiciels</h1>
        ...
        <a href="/pages/addTypeLogiciel.php" class="btn btn-outline-success mb-5" style="margin-top: 20px;">Ajoutez un Type de Logiciel</a>                               
