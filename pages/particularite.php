...
<head>
    ...
    <title>Particularité d'Imprimante</title>
...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            <h1 class="mb-4">Liste des particularités</h1>
                ...
                <table class="table table-striped table-hover table-responsive">
                    ...
                    foreach($result as $row) {
                        ...
                        echo '<tr>';
                            ...
                            echo '<th scope="row">'. $row['ID_Fonction'] .'</th>';
                            echo '<td>'. $row['Nom'] . '</td>';
        ...
        <a href="/pages/addParticularite.php" class="btn btn-outline-success mb-5" style="margin-top: 20px;">Ajoutez une Particularité</a>                               
