...
if (!empty($_GET["id"])) {
    ...
    $ren = Connexion::getDB()->getResult("Select * from Utilisateur");
    $goodid = false;
    foreach ($ren as $num => $name) {
        if ($name["ID_User"] == $_GET["id"]) {
            $goodid = true;
        }
    }
    if (!$goodid) {
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-outline" style="background-color:#d60ea1; border: none;    " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
