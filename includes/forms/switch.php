<form method="POST" action="/includes/traitements/insertSite.php" enctype="multipart/form-data" style="margin: 30px 5% 0 5%;">
    ...
    <hr class="my-4">        
    <h4 class="mb-3">Les Ports</h4>
    <div class="col mb-4">
        <div class="mb-3 form-check" style="margin-left: 2%;">
            <label class="form-check-label" for="4">4 Ports</label>
            <input type="radio" class="form-check-input" id="4" name="ports" value="4">
        </div>
        <div class="mb-3 form-check" style="margin-left: 2%;">
            <label class="form-check-label" for="8">8 Ports</label>
            <input type="radio" class="form-check-input" id="8" name="ports" value="8">
        </div>
        <div class="mb-3 form-check" style="margin-left: 2%;">
            <label class="form-check-label" for="16">16 Ports</label>
            <input type="radio" class="form-check-input" id="16" name="ports" value="16">
        </div>
        <div class="mb-3 form-check" style="margin-left: 2%;">
            <label class="form-check-label" for="32">32 Ports</label>
            <input type="radio" class="form-check-input" id="32" name="ports" value="32">
        </div>
        <div class="mb-3 form-check" style="margin-left: 2%;">
            <label class="form-check-label" for="autre">Autres</label>
            <input type="radio" class="form-check-input" id="autre" name="ports" value="">
            <input type="text" class="form-input" name="autreports">
        </div>
    </div>
    ...
    <button class="w-35 btn btn-secondary btn-lg mb-4" type="submit">Ajouter un Switch</button>
</form>