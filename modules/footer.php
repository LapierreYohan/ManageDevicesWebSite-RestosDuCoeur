<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top mt-5 bg-dark border-dark text-white" style="z-index: 10000;">
    <div class="col-md-4 d-flex align-items-center">
      <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
        <svg class="bi" width="30" height="24"><use xlink:href="#bootstrap"></use></svg>
      </a>
      <span class="mb-3 mb-md-0 resetSelector"><b>© 2022 Resto du Coeur, Tout droits réservés.</b></span>
    </div>

    <ul class="nav col-md-3 justify-content-end list-unstyled d-flex me-5">
